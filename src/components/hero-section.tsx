      ...
      <div className="relative container mx-auto px-4 py-24 md:py-32 lg:py-40">
        <div className="max-w-2xl space-y-4">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
            Imóveis de Alto Padrão em <span className="text-gradient-gold">Balneário Camboriú</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Button size="lg" className="bg-azul-escuro text-white hover:bg-azul-escuro/90">
            <a href="/imoveis"> 
              Ver Imóveis
              </a>
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
            <Button size="lg" variant="outline" className="border-azul-escuro bg-white/20 text-white hover:bg-azul-escuro/90">
